...
const Home = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-52 lg:gap-96 px-4 md:px-5 lg:px-20 py-12 bg-gray-800 text-white animate-fade-in">
      ...
      <div className="w-full md:w-1/2 text-2xl animate-slide-left">
        ...
        <p className="text-5xl md:text-6xl lg:text-7xl font-semibold mb-4 text-fuchsia-400 mt-8 whitespace-nowrap overflow-hidden border-r-4 border-white animate-typing">
